...
function showMoveFleet() {
    ...
    document.getElementById("moveFleetSouthButton").style.display = "block";
     ...
     document.getElementById("moveFleetNorthButton").addEventListener("click", shiftFleet);
//     document.getElementById("moveFleetEastButton").addEventListener("click", shiftFleet("east"));
//     document.getElementById("moveFleetWestButton").addEventListener("click", shiftFleet("south"));
//     document.getElementById("moveFleetSouthButton").addEventListener("click", shiftFleet("west"));
...
//             redrawGrid();
             ...
             alert(JSON.parse(game.playersBoard.rowVariable));
...
//    if(playerShipsSunk > 1 && numMoveFleet >= 1){
    if(!isSetup){ //temporary for testing
        showMoveFleet();
    }
    if(numMoveFleet <= 0){
        hideMoveFleet();
