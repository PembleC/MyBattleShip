...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {
        ...
        router.POST().route("/sonarPulseAttack").with(ApplicationController::sonarPulseAttack); //for Sonar
        router.POST().route("/moveFleet").with(ApplicationController::moveFleet); //for moveing fleet
